 ...
 */
@Composable
fun SuperOrderBillingOutlinedButton(
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
    enabled: Boolean = true,
 ...
 */
@Composable
fun SuperOrderBillingTextButton(
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
    enabled: Boolean = true,
    content: @Composable RowScope.() -> Unit = {},
...
fun SuperOrderBillingTextButton(
    ...
    SuperOrderBillingTextButton(
        onClick = onClick,
        modifier = modifier,
        enabled = enabled,
    ) {
        SuperOrderBillingButtonContent(
            text = text,
 ...
 */
@Composable
private fun SuperOrderBillingButtonContent(
    text: @Composable () -> Unit,
    modifier: Modifier = Modifier,
    leadingIcon: @Composable (() -> Unit)? = null,
) {
...
object SuperOrderBillingButtonDefaults {
    // TODO: File bug
