...
@Composable
fun SuperOrderBillingScaffold(
    backPress: () -> Unit,
    modifier: Modifier = Modifier,
    topBarTitle: String? = null,
    floatingActionButtonContent: FloatingActionButtonContent? = null,
    pullToRefreshState: SuperOrderBillingPullToRefreshState = rememberSuperOrderBillingPullToRefreshState(),
...
data class SuperOrderBillingPullToRefreshState(
...
@Composable
fun rememberSuperOrderBillingPullToRefreshState(
    isEnabled: Boolean = false,
    isRefreshing: Boolean = false,
    onRefresh: () -> Unit = { },
): SuperOrderBillingPullToRefreshState = remember(isEnabled, isRefreshing, onRefresh) {
    SuperOrderBillingPullToRefreshState(
        isEnabled = isEnabled,
