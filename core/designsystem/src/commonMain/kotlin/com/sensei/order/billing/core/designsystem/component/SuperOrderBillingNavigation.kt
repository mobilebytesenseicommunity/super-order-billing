 ...
 */
@Composable
fun RowScope.SuperOrderBillingNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
 ...
 */
@Composable
fun SuperOrderBillingNavigationBar(
    modifier: Modifier = Modifier,
 ...
 */
@Composable
fun SuperOrderBillingNavigationRailItem(
    selected: Boolean,
    onClick: () -> Unit,
    icon: @Composable () -> Unit,
    modifier: Modifier = Modifier,
 ...
 */
@Composable
fun SuperOrderBillingNavigationRail(
    modifier: Modifier = Modifier,
    ...
    NavigationRail(
        ...
        contentColor = SuperOrderBillingNavigationDefaults.navigationContentColor(),
        header = header,
        content = content,
    )
}
...
@Preview
@Composable
fun SuperOrderBillingNavigationBarPreview() {
...
@Preview
@Composable
fun SuperOrderBillingNavigationRailPreview() {
    val items = listOf("Home", "Payments", "Finance", "Profile")
    val icons =
        listOf(
            AppIcons.Home,
    ...
    SuperOrderBillingTheme {
        SuperOrderBillingNavigationRail {
            items.forEachIndexed { index, item ->
 ...
 */
object SuperOrderBillingNavigationDefaults {
    @Composable
