...
fun SuperOrderBillingPasswordField(
    ...
    SuperOrderBillingOutlinedTextField(
        modifier = modifier
            .tabNavigation()
...
fun SuperOrderBillingPasswordField(
    ...
    SuperOrderBillingPasswordField(
        modifier = modifier,
        label = label,
        value = value,
...
@Preview
@Composable
private fun SuperOrderBillingPasswordField_preview_withInput_hidePassword() {
    SuperOrderBillingPasswordField(
        label = "Label",
        value = "Password",
        onValueChange = {},
...
@Preview
@Composable
private fun SuperOrderBillingPasswordField_preview_withInput_showPassword() {
    SuperOrderBillingPasswordField(
        label = "Label",
        value = "Password",
        onValueChange = {},
...
@Preview
@Composable
private fun SuperOrderBillingPasswordField_preview_withoutInput_hidePassword() {
    SuperOrderBillingPasswordField(
        label = "Label",
        value = "",
        onValueChange = {},
...
@Preview
@Composable
private fun SuperOrderBillingPasswordField_preview_withoutInput_showPassword() {
    SuperOrderBillingPasswordField(
        label = "Label",
        value = "",
        onValueChange = {},
