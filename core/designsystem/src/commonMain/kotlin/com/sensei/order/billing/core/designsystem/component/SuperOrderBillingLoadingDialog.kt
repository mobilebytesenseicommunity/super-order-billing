...
@Composable
fun SuperOrderBillingLoadingDialog(
...
@Preview
@Composable
private fun SuperOrderBillingLoadingDialog_preview() {
    SuperOrderBillingTheme {
        SuperOrderBillingLoadingDialog(
...
/**
 * Models display of a [SuperOrderBillingLoadingDialog].
 */
