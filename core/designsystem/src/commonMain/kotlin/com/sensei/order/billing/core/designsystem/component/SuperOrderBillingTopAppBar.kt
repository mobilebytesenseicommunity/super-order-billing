...
import com.sensei.order.billing.core.designsystem.utils.mirrorIfRtl

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SuperOrderBillingTopAppBar(
    title: String,
...
@Preview
@Composable
private fun SuperOrderBillingTopAppBar_preview() {
...
@Preview
@Composable
private fun SuperOrderBillingTopAppBarOverflow_preview() {
    SuperOrderBillingTheme {
        SuperOrderBillingTopAppBar(
...
@Preview
@Composable
private fun SuperOrderBillingTopAppBarOverflowCutoff_preview() {
    SuperOrderBillingTheme {
        SuperOrderBillingTopAppBar(
